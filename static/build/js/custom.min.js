...
/*function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                labels: ["灾难", "严重", "一般", "警告", "信息", "提示"],
                datasets: [{
                    data: [50, 50, 50, 50, 50, 50],
                    backgroundColor: ["#E45959", "#E97659", "#FFA059", "#FFC859", "#7499FF", "97AAB3"],
                    hoverBackgroundColor: ["#E45955", "#E97655", "#FFA055", "#FFC855", "#7499FE", "97AAB0"]
                }]
            },
            options: {
                legend: !1,
...
if ("undefined" != typeof Chart) {
    $.post("/zabbix/dashboard/",
       function(data){
         console.log(typeof(data))
         //var zt = eval('(' + data + ')');
         var zt = data
         console.log(data);
         var myChart = echarts.init(document.getElementById('Dashgraph'));
         //app.title = '环形图';
             ...
             series: [
                 {
                     ...
                     data:[
                         {value:zt.disaster, name:'灾难'},
                         //{value:zt.high.priority__count, name:'严重',label:{normal:{show:true,position: 'center',},emphasis: {show: true,}}},
                         {value:zt.high, name:'严重'},
                         {value:zt.average, name:'一般'},
                         {value:zt.warring, name:'警告'},
                         {value:zt.information, name:'信息'},
                         {value:zt.notclassfield, name:'提示'}
                     ]
                 }
             ]
         };
